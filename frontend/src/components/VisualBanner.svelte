<script>
    ...
    export let background = NEOPLE_UI + "/img/svisual_df.jpg";
    export let title = "로그인";

</script>

<div class="s_visual260 s_df" style="--background-img: url({ background })">
    <h2>{ title }</h2>
    <h3>
        로그인 후 이용하여 주세요.<br>
...
<style>
    .s_df {
        background: var(--background-img) no-repeat 50% 0;
    }
